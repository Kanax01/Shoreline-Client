...
public final class IRCManager implements Globals
{
    ...
    {
        // The original beta used a native bridge for IRC transport.
        // In this restored build, networking is disabled by default.
    }

    private void attemptReconnection(String backupToken)
    {
        // No native transport present in this restored build.
    }

    private List<String> readIncoming()
    {
        return List.of();
    }
